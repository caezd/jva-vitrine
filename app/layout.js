        ...
        <html lang="fr">
            ...
            >
                ...
                <div className="h-screen w-screen isolate overflow-y-auto overflow-x-hidden text-white/80">
                    ...
                    />
                    <div className="mix-blend-exclusion opacity-40 absolute h-screen w-screen overflow-hidden">
                        <video
                    ...
                    <footer className="flex w-full items-end justify-between absolute bottom-0 p-6 xl:py-8">
                        <div>
