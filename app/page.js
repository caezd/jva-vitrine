...
export default function Home() {
    return (
        <div className="relative sm:mt-20 mt-8">
            <div className="flex flex-col gap-4">
                <h2 className="text-2xl sm:text-4xl drop-shadow-lg font-nunito text-white">
                    « J'y vais accompagné » arrive
                    <br />
                    <span className="text-7xl sm:text-9xl inline-flex mt-4">
                        BIENT
